  ...
  return (
    <section className="py-24 lg:py-36 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="relative rounded-2xl p-8 lg:p-14 overflow-hidden bg-white card-shadow-lg">
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-6 lg:pl-14 lg:border-l lg:border-border/40">
              ...
              <div className="grid grid-cols-3 gap-6 pt-5 border-t border-border/40">
                <div>
                  <p className="text-2xl font-semibold text-foreground font-[var(--font-heading)]">500+</p>
                  <p className="text-xs text-muted-foreground mt-0.5">Projects guided</p>
                </div>
                <div>
                  <p className="text-2xl font-semibold text-foreground font-[var(--font-heading)]">15%</p>
                  <p className="text-xs text-muted-foreground mt-0.5">Costs saved</p>
                </div>
                <div>
